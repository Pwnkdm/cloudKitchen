      ...
      {userLoading ? (
        ...
        <>
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            >
              <form onSubmit={handleLoginRegister} className="space-y-6">
                {isSignUp && (
                  <>
                    <div>
              ...
              <p className="mt-6 text-center text-sm text-gray-400">
                {isSignUp ? (
                  <>
                    ...
                    <p onClick={toggleSignUp} className="cursor-pointer font-medium text-indigo-500 hover:text-indigo-400">
                      Sign in
                    </p>
                  </>
                ) : (
