        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          ...
          <div className="mb-4 md:mb-0">
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="hover:text-blue-600"><FaFacebookF size={24} /></a>
              ...
              <a href="https://linkedin.com" className="hover:text-blue-700"><FaLinkedinIn size={24} /></a>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-700 pt-4">
          <p className="text-center text-gray-400 text-sm">&copy; {new Date().getFullYear()} Company Name. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
